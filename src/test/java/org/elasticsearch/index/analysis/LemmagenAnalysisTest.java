...
public class LemmagenAnalysisTest extends BaseTokenStreamTestCase {
    ...
    public void testLemmagenFilterFactoryWithDefaultLexicon() throws IOException {
        ...
        Tokenizer tokenizer = new UAX29URLEmailTokenizer(Version.CURRENT.luceneVersion, new StringReader(source));
    ...
    public AnalysisService createAnalysisService() {
        Settings settings = ImmutableSettings.settingsBuilder().loadFromClasspath("org/elasticsearch/index/analysis/lemmagen.json").build();
